...
egrep "^-w\s+/etc/sysconfig/network-scripts\s+-p\s+wa\s+-k\s+system-locale\s*$" /etc/audit/audit.rules || echo "-w /etc/sysconfig/network-scripts -p wa -k system-locale" >> /etc/audit/audit.rules
...
egrep "^-w\s+/usr/share/selinux/\s+-p\s+wa\s+-k\s+MAC-policy\s*$" /etc/audit/audit.rules || echo "-w /usr/share/selinux/ -p wa -k MAC-policy" >> /etc/audit/audit.rules
...
egrep "^-w\s+/var/log/wtmp\s+-p\s+wa\s+-k\s+logins\s*$" /etc/audit/audit.rules || echo "-w /var/log/wtmp -p wa -k logins" >> /etc/audit/audit.rules
egrep "^-w\s+/var/log/btmp\s+-p\s+wa\s+-k\s+logins\s*$" /etc/audit/audit.rules || echo "-w /var/log/btmp -p wa -k logins" >> /etc/audit/audit.rules
...
chkconfig --list syslog-ng && chkconfig syslog-ng on
...
egrep -q "^(\s*)MACs\s+\S+(\s*#.*)?\s*$" /etc/ssh/sshd_config && sed -ri "s/^(\s*)MACs\s+\S+(\s*#.*)?\s*$/\MACs hmac-sha2-512,hmac-sha2-256\2/" /etc/ssh/sshd_config || echo "MACs hmac-sha2-512,hmac-sha2-256" >> /etc/ssh/sshd_config
...
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/system-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+try_first_pass)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1try_first_pass \2/ }' /etc/pam.d/system-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/system-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/system-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+retry=[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1retry=3 \2/ }' /etc/pam.d/system-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)retry=[0-9]+(\s+.*)?$/\1retry=3\3/' /etc/pam.d/system-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/system-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/system-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+minlen=[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1minlen=9 \2/ }' /etc/pam.d/system-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)minlen=[0-9]+(\s+.*)?$/\1minlen=9\3/' /etc/pam.d/system-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/system-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/system-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+dcredit=-?[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1dcredit=-1 \2/ }' /etc/pam.d/system-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)dcredit=-?[0-9]+(\s+.*)?$/\1dcredit=-1\3/' /etc/pam.d/system-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/system-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/system-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+ucredit=-?[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1ucredit=-1 \2/ }' /etc/pam.d/system-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)ucredit=-?[0-9]+(\s+.*)?$/\1ucredit=-1\3/' /etc/pam.d/system-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/system-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/system-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+ocredit=-?[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1ocredit=-1 \2/ }' /etc/pam.d/system-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)ocredit=-?[0-9]+(\s+.*)?$/\1ocredit=-1\3/' /etc/pam.d/system-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/system-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/system-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+lcredit=-?[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1lcredit=-1 \2/ }' /etc/pam.d/system-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)lcredit=-?[0-9]+(\s+.*)?$/\1lcredit=-1\3/' /etc/pam.d/system-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/system-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/password-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+try_first_pass)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1try_first_pass \2/ }' /etc/pam.d/password-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/password-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/password-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+retry=[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1retry=3 \2/ }' /etc/pam.d/password-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)retry=[0-9]+(\s+.*)?$/\1retry=3\3/' /etc/pam.d/password-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/password-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/password-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+minlen=[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1minlen=9 \2/ }' /etc/pam.d/password-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)minlen=[0-9]+(\s+.*)?$/\1minlen=9\3/' /etc/pam.d/password-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/password-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/password-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+dcredit=-?[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1dcredit=-1 \2/ }' /etc/pam.d/password-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)dcredit=-?[0-9]+(\s+.*)?$/\1dcredit=-1\3/' /etc/pam.d/password-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/password-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/password-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+ucredit=-?[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1ucredit=-1 \2/ }' /etc/pam.d/password-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)ucredit=-?[0-9]+(\s+.*)?$/\1ucredit=-1\3/' /etc/pam.d/password-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/password-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/password-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+ocredit=-?[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1ocredit=-1 \2/ }' /etc/pam.d/password-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)ocredit=-?[0-9]+(\s+.*)?$/\1ocredit=-1\3/' /etc/pam.d/password-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/password-auth not configured.
egrep -q "^\s*password\s+requisite\s+pam_cracklib.so\s+" /etc/pam.d/password-auth && sed -ri '/^\s*password\s+requisite\s+pam_cracklib.so\s+/ { /^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*(\s+lcredit=-?[0-9]+)(\s+.*)?$/! s/^(\s*password\s+requisite\s+pam_cracklib.so\s+)(.*)$/\1lcredit=-1 \2/ }' /etc/pam.d/password-auth && sed -ri 's/(^\s*password\s+requisite\s+pam_cracklib.so(\s+\S+)*\s+)lcredit=-?[0-9]+(\s+.*)?$/\1lcredit=-1\3/' /etc/pam.d/password-auth || echo Ensure\ password\ creation\ requirements\ are\ configured - /etc/pam.d/password-auth not configured.
...
#SSH Insecure HMAC Algorithms Enabled and CBC mode  Ciphers enabled (DEDOD-808)
sed -i '/^Ciphers/d' /etc/ssh/sshd_config
echo "Ciphers aes128-ctr,aes192-ctr,aes256-ctr,arcfour256,arcfour128,arcfour" >> /etc/ssh/sshd_config
sed -i '/^MACs/d' /etc/ssh/sshd_config
echo "MACs hmac-sha1,umac-64@openssh.com,hmac-ripemd160,hmac-sha2-256,hmac-sha2-512,hmac-ripemd160@openssh.com" >> /etc/ssh/sshd_config
